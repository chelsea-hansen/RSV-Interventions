...
|*Relative risk of infection following third or later infection (&sigma;<sub>3</sub>)|0.4|
|Relative risk of infection with maternal immunity (&sigma;<sub>3</sub>)|0.4|
...
Visualize your results in the Shiny App! Code is provided in the ```4. Visualizations``` folder and a working example is available [here](https://chelsea-doing-epi.shinyapps.io/rsv-app/).
