...
monoclonal_birthO = curves$monoclonal_week*(monoclonal_coverO/mean(curves$monoclonal_week[1501:1525]))
monoclonal_birthP = curves$monoclonal_week*(monoclonal_coverP/mean(curves$monoclonal_week[1501:1525]))

maternal_curveO = curves$maternal_week*(maternal_coverO/mean(curves$maternal_week[1501:1525]))
maternal_curveP = curves$maternal_week*(maternal_coverP/mean(curves$maternal_week[1501:1525]))
...
counterfact = interventions(birth_dose=monoclonal_counter,#monoclonal_counter, #vector of infants receiving birth doses of nirsevimab
                             ...
                             maternal_dose=maternal_counter,#maternal_counter, #vector of infants protected by maternal vacciantion 
...
ScenarioA = interventions(birth_dose=monoclonal_birthO, 
...
#version with confidence intervals - will take more time to run 
ScenarioA_PI = interventions_PI(birth_dose=monoclonal_birthO, 
                                cover_n=monoclonal_curveO, 
                                waningN=180, 
                                RRIn=1, 
                                RRHn=0.2,
...
ScenarioB = interventions(birth_dose=monoclonal_birthO,
                          cover_n=monoclonal_curveO,
                          waningN=180, 
                          RRIn=1, 
                          RRHn=0.2,
...
#version with confidence intervals - will take more time to run 
ScenarioB_PI = interventions_PI(birth_dose=monoclonal_birthO, 
                                cover_n=monoclonal_curveO, 
                                waningN=180, 
                                RRIn=1, 
                                RRHn=0.2,
...
ScenarioC = interventions(birth_dose=monoclonal_birthP,
...
#version with confidence intervals - will take more time to run 
ScenarioC_PI = interventions_PI(birth_dose=monoclonal_birthP, 
                                cover_n=monoclonal_curveP, 
                                waningN=180, 
                                RRIn=1, 
                                RRHn=0.4,
...
ScenarioD = interventions(birth_dose=monoclonal_birthP, 
                          cover_n=monoclonal_curveP, 
                          waningN=180, 
                          RRIn=1, 
                          RRHn=0.4,
...
#version with confidence intervals - will take more time to run 
ScenarioD_PI = interventions_PI(birth_dose=monoclonal_birthP, 
                                cover_n=monoclonal_curveP, 
                                waningN=180, 
                                RRIn=1, 
                                RRHn=0.4,
...
ScenarioE = interventions(birth_dose=monoclonal_birthO, 
                          cover_n=monoclonal_curveO, 
                          waningN=180, 
                          RRIn=1, 
                          RRHn=0.2,
...
#version with confidence intervals - will take more time to run 
ScenarioE_PI = interventions_PI(birth_dose=monoclonal_birthO, 
                                cover_n=monoclonal_curveO, 
                                waningN=180, 
                                RRIn=1, 
                                RRHn=0.2,
...
ScenarioF = interventions(birth_dose=monoclonal_birthO, 
                          cover_n=monoclonal_curveO, 
                          waningN=180, 
                          RRIn=1, 
                          RRHn=0.2,
...
#version with confidence intervals - will take more time to run 
ScenarioF_PI = interventions_PI(birth_dose=monoclonal_birthO, 
                                cover_n=monoclonal_curveO, 
                                waningN=180, 
                                RRIn=1, 
                                RRHn=0.2,
...
ScenarioG = interventions(birth_dose=monoclonal_birthO, 
                          cover_n=monoclonal_curveO, 
                          waningN=180, 
                          RRIn=1, 
                          RRHn=0.4,
...
#version with confidence intervals - will take more time to run 
ScenarioG_PI = interventions_PI(birth_dose=monoclonal_birthP, 
                                cover_n=monoclonal_curveP, 
                                waningN=180, 
                                RRIn=1, 
                                RRHn=0.4,
...
ScenarioH = interventions(birth_dose=monoclonal_birthP, 
                          cover_n=monoclonal_curveP, 
                          waningN=180, 
                          RRIn=1, 
                          RRHn=0.4,
...
#version with confidence intervals - will take more time to run 
ScenarioH_PI = interventions_PI(birth_dose=monoclonal_birthP, 
                                cover_n=monoclonal_curveP, 
                                waningN=180, 
                                RRIn=1, 
                                RRHn=0.4,
...
saveRDS(all_scenarios,"RSV-Scenarios-Shiny-App/scenario_point_estimates.rds")
...
all_scenarios_PI=rbind(counterfact_PI,ScenarioA_PI,ScenarioB_PI,ScenarioC_PI,ScenarioD_PI,
  ...
  filter(!is.na(sample))
saveRDS(all_scenarios_PI,"RSV-Scenarios-Shiny-App/scenarios_with_PI.rds")
